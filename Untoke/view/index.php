		...
		<div class="background-color-hero">
			...
			<div class="hero">
				<div class="hero-text">
					...
					<!-- aquí se mostrará el efecto de maquina de escribir -->
					<span id="typed"></span>
				</div>
			</div>
		</div>
			...
			<div class="row d-flex align-items-center">
				<div class="col-md-7 col-lg-8">
					...
					<p class="text-center text-md-left">© 2018 Copyright:
						<strong> Untoke</strong> | Todos los derechos reservados
					</p>
				</div>
					...
					<div class="text-center text-md-right">
						<ul class="list-unstyled list-inline">
							<li class="list-inline-item">
								<a href="https://www.facebook.com/untokePE/" class="btn-floating btn-sm rgba-white-slight mx-1">
							...
							<li class="list-inline-item">
								<a href="https://www.instagram.com/untokeapp/?hl=es-la" class="btn-floating btn-sm rgba-white-slight mx-1">
